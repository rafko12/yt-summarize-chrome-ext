...
| Targety dystrybucji   | Antigravity, Codex, Claude         | Środowiska asystentów korzystające z commitowanych skilli projektu i podpakietu | [`apm.yml`](apm.yml), [`.agents/skills/`](.agents/skills/), [`packages/mattpocock-skills/`](packages/mattpocock-skills/) |
